-- Resilient parent_id: if the referenced parent does not exist, use null instead of failing.
-- Handles races (e.g. parent deleted before our update applied) and op ordering edge cases.
