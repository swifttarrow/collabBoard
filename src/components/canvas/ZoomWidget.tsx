...
export function ZoomWidget({
  ...
  return (
    <div
      className="pointer-events-auto absolute right-4 top-4 z-[90] flex items-center gap-0.5 rounded-md border border-slate-200 bg-white/95 px-1 py-1 shadow-sm backdrop-blur-sm"
    ...
    >
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end" side="top" className="min-w-[8rem]">
          ...
          <DropdownMenuSeparator />
          <DropdownMenuItem onClick={handleFit} className="gap-2">
